 ...
 */
 ...
 // define margins scatterplot
  ...
  // determine initial attributes for circle
  var circleInitial = {
      "class":"dot", 
      "cx": 0,
      "cy": 0,
  ...
  // determine attributes for circle after transition 
...
// implement functions that require data
d3.json("FinalDataScatter.json", function(data){
    ...
    // determine domain for circle scale 
    scale_circle
